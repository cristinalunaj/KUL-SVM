...
% for sigmafactor=0.7%[0.001,0.01,0.1,1,10,100]
...
%
figure; 
title(strcat('Denosing using kernel PCA, sig2:', num2str(sig2)));
colormap('gray'); 
tic
...
mae_training = mean(errordtrain');
mae_test1 = mean(errordt');
mae_test2 = mean(errordtest');

% saveas(gcf,strcat('plotsPCA/HWdigits_sig_',num2str(sig2),'.jpg'))
% savefig(strcat('plotsPCA/HWdigits_sig_',num2str(sig2),'.fig'))
% close all
