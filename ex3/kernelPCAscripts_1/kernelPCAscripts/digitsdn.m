...
for sigmafactor=[0.001,0.01,0.1,1,10,100]
...
saveas(gcf,strcat('plotsPCA/HWdigits_sigFactor_',num2str(sigmafactor),'.jpg'))
savefig(strcat('plotsPCA/HWdigits_sigFactor_',num2str(sigmafactor),'.fig'))
close all
...
saveas(gcf,strcat('plotsPCA/HW_linearPCAdigits_sigFactor_',num2str(sigmafactor),'.jpg'))
savefig(strcat('plotsPCA/HW_linearPCAdigits_sigFactor_',num2str(sigmafactor),'.fig'))
close all
